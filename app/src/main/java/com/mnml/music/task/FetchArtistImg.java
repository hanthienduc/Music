...
public class FetchArtistImg {
    ...
    private void backgroundTask() {
        try {
            ...
            String jsonResult =
                    inputStreamToString(new BufferedInputStream(connection.getInputStream())).toString();
            try {
    ...
    private String saveImageToStorage(Bitmap bitmap) {
        ...
        String filePath =
                sdCardDirectory + "/" + context.getResources().getString(R.string.app_name) + "/artist/";
