...
public class MediaButtonIntentReceiver extends WakefulBroadcastReceiver {
    ...
    static boolean handleIntent(final Context context, final Intent intent) {
    ...
    private static void acquireWakeLockAndSendMessage(Context context, Message msg, long delay) {
        if (mWakeLock == null) {
            ...
            mWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Mnml Player headset button");
