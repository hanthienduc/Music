package com.mnmlos.music.adapters;
...
import com.mnmlos.music.items.Album;
import com.mnmlos.music.ui.activity.AlbumActivity;
...
public class AlbumsAdapter extends RecyclerView.Adapter<AlbumsAdapter.SimpleItemViewHolder>
    ...
    public AlbumsAdapter(Context context, List<Album> items, RequestManager glide) {
        ...
        this.items = items;
        final int px = Utils.dpToPx(context, com.mnmlos.music.utils.Config.ALBUM_CARD_WIDTH);
