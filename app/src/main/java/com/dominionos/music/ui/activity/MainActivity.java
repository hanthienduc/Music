...
import com.dominionos.music.ui.fragments.*;
...
public class MainActivity extends ATHToolbarActivity {
    ...
    private final ServiceConnection billingConnection =
    ...
    private void setDrawer() {
        ...
        final PrimaryDrawerItem albums =
                new PrimaryDrawerItem()
                        .withSelectedTextColor(accentColor)
                        .withSelectedIconColor(accentColor)
                        .withIdentifier(1)
        ...
        final PrimaryDrawerItem artists =
                new PrimaryDrawerItem()
                        .withSelectedTextColor(accentColor)
                        .withSelectedIconColor(accentColor)
                        .withIdentifier(2)
        ...
        final PrimaryDrawerItem playlist =
                new PrimaryDrawerItem()
                        .withSelectedTextColor(accentColor)
                        .withSelectedIconColor(accentColor)
                        .withIdentifier(3)
